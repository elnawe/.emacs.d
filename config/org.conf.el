(use-package org
  ...
  :preface
  (defvar nemacs-org-dir "~/OneDrive - ITX Corp/NEMACS/")

  (defvar nemacs-org-inbox-file (concat nemacs-org-dir "inbox.org"))
  ...
  :custom
  (org-archive-location (concat nemacs-org-dir "archive.org"))
  (org-blank-before-new-entry '((heading . t) (plain-list-item . t)))
  (org-deadline-warning-days 7)
  (org-default-notes-file (concat nemacs-org-dir "inbox.org"))
  ...
  (org-refile-targets `(((,org-default-notes-file) :maxlevel . 3)))
  ...
  (org-tag-persistent-alist '(("#email"   . ?e)
                              ("@meeting" . ?m)
                              ("#SDD"     . ?s)))
  (org-tags-column 0)
  ...
  (org-todo-keyword-faces '(("TODO"     . org-todo)
                            ...
                            ("CANCELED" . (:foreground "red"
                                                       ...
                                                       :weight bold))))
  :custom-face
  (org-ellipsis ((t (:weight bold))))
  (org-done ((t (:underline t :weight bold))))
...
(use-package org-agenda
  ...
  (org-agenda-custom-commands '(("r" "Daily Review" ((tags-todo "Today")
                                ...
                                ("gtd" "My GTD Agenda" ((agenda "" ((org-agenda-overriding-header "Getting Things Done")
                                                                    ...
                                                                    (org-deadline-warning-days 7)
                                                                    (org-agenda-start-on-weekday nil)))))))
  (org-agenda-files `(,nemacs-org-inbox-file))
...
(use-package org-capture
  ...
  (org-capture-templates `(("t" "Add TODO Task" entry (file ,org-default-notes-file)
                           ...
                           ("T" "Add Linked TODO Task" entry (file ,org-default-notes-file)
                            ...
                            :empty-lines 1 :immediate-finish t)
                           ("c" "Add Contact" entry (file ,(concat nemacs-org-dir "contacts.org"))
...
(use-package org-contacts
  ...
  (org-contacts-files `(,(concat nemacs-org-dir "contacts.org"))))

(use-package org-id
  :ensure nil
  :after org
  :custom
  (org-id-locations-file (concat nemacs-org-dir "org-ids"))
