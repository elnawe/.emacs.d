...
(zenburn-with-color-variables
  (custom-set-faces
   ...
   `(powerline-active0 ((t (:background ,zenburn-green-5 :foreground ,zenburn-fg+1))))
   `(powerline-active1 ((t (:background ,zenburn-green-5 :foreground ,zenburn-fg+1))))
   `(powerline-active2 ((t (:background ,zenburn-green-5 :foreground ,zenburn-fg+1))))
   ...
   `(mode-line-inactive ((t :background ,zenburn-bg :foreground ,zenburn-fg-05)))
   `(powerline-inactive0 ((t :background ,zenburn-bg :foreground ,zenburn-fg-05)))
   `(powerline-inactive1 ((t :background ,zenburn-bg :foreground ,zenburn-fg-05)))
   `(powerline-inactive2 ((t :background ,zenburn-bg :foreground ,zenburn-fg-05)))))
